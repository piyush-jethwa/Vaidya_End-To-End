...
import VaidyaAIAgent from "./pages/VaidyaAIAgent";
import ChatAssistant from "./pages/ChatAssistant";
import TriageRadiology from "./pages/TriageRadiology";
import ReportAuditor from "./pages/ReportAuditor";
import DoctorRecommenderPage from "./pages/DoctorRecommender";
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/vaidya-ai-gemini-agent" element={<VaidyaAIAgent />} />
          <Route path="/chat-assistant" element={<ChatAssistant />} />
          <Route path="/triage-radiology" element={<TriageRadiology />} />
          <Route path="/report-auditor" element={<ReportAuditor />} />
